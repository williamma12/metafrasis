...
from app.services.annotation.models import AnnotationDataset, Region
from app.services.annotation.storage import AnnotationStorage
from ml.training.evaluate.detectors import PrecisionRecallF1Metric
...
class DetectorDataset(Dataset):
    ...
    def _getitem_annotation(self, idx: int) -> Tuple[torch.Tensor, Dict[str, torch.Tensor]]:
        ...
        from app.services.annotation.models import Point
        scaled_regions = []
